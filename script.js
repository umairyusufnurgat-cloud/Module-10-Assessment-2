    ...
    if (isEditing) {
        ...
        if (recipeIndex !== -1) {
            recipes[recipeIndex] = {
                ...
                image: document.getElementById('recipeImage').value || recipes[recipeIndex].image,
        ...
        const newRecipe = {
            ...
            difficulty: document.getElementById('recipeDifficulty').value,
            servings: parseInt(document.getElementById('recipeServings').value),
            image: document.getElementById('recipeImage').value || 'https://via.placeholder.com/600x400/f0f0f0/999?text=Recipe+Image',
            ingredients: document.getElementById('recipeIngredients').value.split('\n').filter(ing => ing.trim()),
            instructions: document.getElementById('recipeInstructions').value.split('\n').filter(inst => inst.trim())
        };
