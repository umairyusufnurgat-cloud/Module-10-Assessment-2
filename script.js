...
function showRecipeDetail(recipeId) {
    ...
    document.getElementById('modalRecipeText').innerHTML = recipe.text ? 
        recipe.text.replace(/\n/g, '<br>') : 
        (recipe.ingredients.join('<br>') + '<br><br>' + recipe.instructions.join('<br>'));
...
// Open file upload (for desktop/gallery access)
...
function handleScanUpload(event) {
    ...
    Tesseract.recognize(
        ...
        // Simply put all extracted text in the textarea
    ...
    if (isEditing) {
        ...
        if (recipeIndex !== -1) {
            recipes[recipeIndex] = {
                ...
                difficulty: 'Medium',
                servings: 1,
                image: 'https://via.placeholder.com/600x400/f0f0f0/999?text=Scanned+Recipe',
                ingredients: ['See recipe text'],
                instructions: ['See recipe text']
            };
        }
